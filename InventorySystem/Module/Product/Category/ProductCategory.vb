Public Class ProductCategory
    ...
    Private Sub MB_Save_Click(sender As Object, e As EventArgs) Handles MB_Save.Click
        Try
            ...
            If SelectedID Then
                Dim division = ProductCategoryDB.Update(SelectedID, Name, Description)
                ...
                End If
            Else
                Dim division = ProductCategoryDB.Insert(Name, Description)
    ...
    Private Sub DGV_Load()
        Try
            ...
            Dim divisions = ProductCategoryDB.Fetch()
    ...
    Private Sub MB_Delete_Click(sender As Object, e As EventArgs) Handles MB_Delete.Click
        Try
            Dim ID = SelectedID
            Dim division = ProductCategoryDB.Delete(ID)
